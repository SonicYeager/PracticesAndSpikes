...
const binp = path.join(cargoDir, "bin", "RustToNpmTrial");

if (fs.existsSync(binp)) {
  console.log("Uninstalling RustToNpmTrial...");
  exec(`cargo uninstall RustToNpmTrial`, (error, stdout, stderr) => {
    console.log(stdout);
    if (error || stderr) {
  ...
  console.log("RustToNpmTrial not found skipping!");
}
