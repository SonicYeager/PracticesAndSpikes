...
public sealed class RandomFactsApiPageViewModel : BaseViewModel
{
    ...
    {
        get => _joke;
        set => RaiseAndSetIfChanged(ref _joke, value);
    }
    public string Id
    {
        get => _id;
    ...
    {
        get => _createdAt;
        set => RaiseAndSetIfChanged(ref _createdAt, value);
    }
    public DateTime UpdatedAt
    {
        get => _updatedAt;
        set => RaiseAndSetIfChanged(ref _updatedAt, value);
    }
    public Uri IconUrl
    {
        get => _iconUrl;
        set => RaiseAndSetIfChanged(ref _iconUrl, value);
    }
    public Uri Url
    {
        get => _url;
