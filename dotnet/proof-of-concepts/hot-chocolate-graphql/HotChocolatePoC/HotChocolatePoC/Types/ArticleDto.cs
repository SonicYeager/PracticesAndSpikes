...
/// <summary>
/// Specific article that can be purchased.
/// </summary>
public sealed class ArticleDto
{
    /// <summary>
    /// <see cref="ArticleNumber"/> concatenated with the <see cref="VariantId"/>.
    /// </summary>
    ...
    /// </summary>
    public SupplierPropertiesDto? SupplierProperties { get; set; }
    ...
    /// <summary>
    /// The ids of the articles which are similar in production
    /// </summary>
    public IEnumerable<string> SimilarArticles { get; set; }
